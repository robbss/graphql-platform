...
{
    /// <summary>
    /// The suffix appended to a subject to form the subject scheduled messages are published to.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets the subject scheduled messages for the specified subject are published to.
    /// </summary>
    /// <param name="subject">The subject the message is finally delivered to.</param>
    /// <returns>The scheduling subject.</returns>
    public static string ToSchedulingSubject(string subject)
    {
